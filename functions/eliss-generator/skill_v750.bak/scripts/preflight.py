...
def run_preflight(domain, company=None, github_slug=None, timeout=DEFAULT_TIMEOUT_SECS, log=None):
...
def main(argv=None):
    ...
    if not args.quiet:
        ...
        print(
            f'[preflight] wrote {out_path} — {summary["probes_yielded_signal"]}/12 probes yielded signal '
